...
function Card({
  ...
  return (
    <div
      ...
      data-theme-target="settings-card"
      className={cn(
        "group/card flex flex-col gap-(--card-spacing) overflow-hidden rounded-2xl bg-settings-card py-(--card-spacing) text-sm text-settings-card-foreground ring-1 ring-settings-card-border [--card-spacing:--spacing(6)] has-[>img:first-child]:pt-0 data-[size=sm]:[--card-spacing:--spacing(4)] *:[img:first-child]:rounded-t-xl *:[img:last-child]:rounded-b-xl",
        className
      )}
      {...props}
    />
